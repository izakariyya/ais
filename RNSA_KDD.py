...
#kdd = pd.read_csv('kdd_10.csv')

#Transform_Data = kdd.apply(LabelEncoder().fit_transform)

#Transform_Data.to_csv('Encoded_kdd_10.csv')

#np.savetxt('complt_dt', nusw_data, delimiter =",")

#projected_data = PCA(20).fit_transform(iot_data_small)
    
#np.savetxt('PCA_small_IoT', projected_data, delimiter =",")
